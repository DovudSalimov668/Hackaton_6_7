"""
Django settings for banking_mvp project.
...
SECRET_KEY = 'django-insecure-hackathon-mvp-banking-app-secret-key-change-in-production'
...
WSGI_APPLICATION = 'banking_mvp.wsgi.application'
